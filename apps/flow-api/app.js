...
function createApp() {
  ...
  const wrapAsyncRoute = (handler) => (req, res, next) => {
  ...
  app.get('/ready', wrapAsyncRoute(async (_req, res) => {
  ...
  app.post('/api/flow/oi/sync', wrapAsyncRoute(syncOiHandler));
  app.get('/api/flow/historical', wrapAsyncRoute(historicalFlowHandler));
  ...
  app.post('/api/v1/flow/oi/sync', wrapAsyncRoute(syncOiHandler));
  app.get('/api/v1/flow/historical', wrapAsyncRoute(historicalFlowHandler));
