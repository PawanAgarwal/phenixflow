...
RUN_ROOT="${AUDITED_GAP_RUN_ROOT:-$APP_ROOT/artifacts/reports/audited-gap-remediation-$TS}"
...
node "$REPO_ROOT/infra/clickhouse/scripts/sync-sofr-daily.js" --refresh 1 --years 3 \
